...
public class HighscoreTable : MonoBehaviour {
    ...
    private void Awake() {
        ...
        if (highscores == null) {
            ...
            AddHighscoreEntry(1000000, "Tomas");
            AddHighscoreEntry(897621, "Edvinas");
            AddHighscoreEntry(872931, "Tomasz");
            AddHighscoreEntry(785123, "Agnė");
            AddHighscoreEntry(542024, "Linas");
            AddHighscoreEntry(68245, "Virginijus");
            // Reload
